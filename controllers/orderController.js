...
exports.createOrder = async (req, res) => {
  try {
    const { product, user, quantity, totalPrice, shippingAddress, paymentMethod } = req.body;
...
exports.updateOrder = async (req, res) => {
    try {
        const { id } = req.params;
        const { product, user, quantity, totalPrice, shippingAddress, paymentMethod, status } = req.body;
